...
int main() {
    printf("Welcome to Sphere Volume Calculation Center.\n");

    double radiusOfSphere;
    double volumeOfSphere;

    printf("\nEnter the radius of the sphere: ");
    scanf("%lf", &radiusOfSphere);
    
    volumeOfSphere = (4.0/3.0) * PI * (radiusOfSphere * radiusOfSphere * radiusOfSphere);

    printf("\nVOLUME = %.3lf", volumeOfSphere);
